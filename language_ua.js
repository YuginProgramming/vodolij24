...
const phrases = {
    ...
    bonusNotificationCard: (litersChange, litersPrice, bonusLiters) => {
      return `Дякуємо, Вашу картку було поповнено. Зараховано "${litersChange}" літрів на суму "${litersPrice} грн" + "${bonusLiters}" бонусних літрів`;
    },
    bonusNotificationCardError: `Оплата не пройшла, бонуси не нараховано, якщо ви завершили оплату, звяжіться зі службою підтримки`,
