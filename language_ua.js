...
const phrases = {
  ...
  birthDateRequest:
    "Введіть дату народження у форматі ДД.ММ.РРРР, наприклад 26.02.1992",
  wrongBirthDate:
    "Некоректна дата. Введіть дату народження у форматі ДД.ММ.РРРР, наприклад 26.02.1992",
  phoneRules:
  ...
  userBonusAcc: `💫 Ваші бонуси при обороті/n✅ 0 БОНУСНИХ грн /n20% від поповнення/n
    ...
    `,
  wrongNumber: `Номер не відповідає, жодному автомату в базі. Спробуйте ще раз.`,
  ...
  cardRefilCard: (cardNumber) => {
    return `Поповнення картки номер "${cardNumber}". Оберіть будь ласка бажану суму літрів або гривень для поповнення балансу. Баланс картки завжди в літрах, тому в момент поповнення на Вашу картку буде зарахована кількість літрів за ціною ${Math.floor(
      dataBot.topUpPrice
    )} грн ${
      dataBot.topUpPrice.toFixed(2).split(".")[1]
    } копійок за 1 літр + бонус від 20 до 30% згідно з бонусною ставкою Вашої картки `;
  },
...
const keyboards = {
  ...
  twoWaters: {
    inline_keyboard: [
      ...
      [
        {
          text: "Мінералізована вода - 2.5 грн/л",
